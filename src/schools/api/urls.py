...
urlpatterns = [
    ...
    path('section_list_create', SectionListCreate.as_view(), name='SectionListCreate'),
    path('section_retrive_update_delete/<int:pk>', SectionRetriveUpdateDestroy.as_view(),
        name='SectionRetriveUpdateDestroy'),
    path('subject_list_create', SubjectListCreate.as_view(), name='SubjectListCreate'),
    path('subject_retrive_update_delete/<int:pk>', SubjectRetriveUpdateDestroy.as_view(),
        name='SubjectRetriveUpdateDestroy'),
    path('license_list_create', LicenseListCreate.as_view(), name='LicenseListCreate'),
