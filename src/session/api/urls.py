...
urlpatterns = [
    ...
    path('academic_session_list', AcademicSessionList.as_view(),
         name='AcademicSessionList'),
     path('academic_session_create', AcademicSessionCreate.as_view(),
         name='AcademicSessionCreate'),
    ...
    path('academic_session_retrive_update_delete/<int:pk>', AcademicSessionRetriveUpdateDestroy.as_view(),
     ...
     path('associate_section_retrive_update_delete/<int:pk>', AssociateSectionRetriveUpdateDestroy.as_view(),
         name='AssociateSectionRetriveUpdateDestroy'),
    path('academic_calender_list', AcademicCalenderListView.as_view(),
         name='AcademicCalenderList'),
     path('academic_calender_create', AcademicCalenderCreateView.as_view(),
         name='AcademicCalenderCreate'),
    ...
    path('grade_and_section_list_by_school_academic',GradeAndSectionListBySchoolAcademic.as_view(),
         name='GradeAndSectionListBySchoolAcademic'),
