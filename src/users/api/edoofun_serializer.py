        ...
        try:
            ...
            try:
                if User.objects.filter(email=validated_data['email']).exists():
                    ...
                    user_obj = User.objects.filter(email=validated_data['email'])
                    if UserDetail.objects.filter(user_obj=user_obj, phone=self.context['user_detail_data']['phone']).exists():
